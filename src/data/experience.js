/**
 * Vishal Dhawal — Experience, Leadership & Education Data
 */
...
export const workExperience = [
  {
    id: "up-police-intern",
    role: "AI / ML Intern",
    organization: "Cyber Crime Headquarters, Uttar Pradesh Police",
    location: "Lucknow, India",
    period: "June 2026 — July 2026",
    type: "Internship",
    badge: "LAW ENFORCEMENT & THREAT INTEL",
    badgeColor: "var(--cyan)",
    highlights: [
      "Engineered TeleWire, integrating Telegram MTProto/APIs and asynchronous worker pipelines for real-time threat intelligence monitoring across suspect channels.",
      "Implemented automated NLP workflows using Sentence Transformers, FAISS vector indexing, zero-shot classification, and entity extraction for intelligence alerts.",
      "Integrated blockchain analysis APIs and REST webhooks with Flask, Streamlit, and SQLite for threat actor profiling and automated case reporting."
    ],
  ...
  },
  {
    ...
    highlights: [
      ...
      "Collaborated on technical initiatives bridging mobile client interfaces with backend and edge AI services."
    ],
...
export const educationHistory = [
  {
    ...
    period: "Aug 2023 — April 2027",
    gpa: "7.3 / 10 (through Sem 6)",
    status: "CURRENT",
    highlights: [
      "Core coursework: Computer Vision, Deep Learning, Data Structures & Algorithms, Operating Systems, Computer Networks, Database Systems.",
      "Active contributor to Beta Labs (Technical Club) and campus open-source development."
    ]
  },
  {
    id: "iit-mandi",
    degree: "Minor in Computer Science and Advanced Technologies",
    institution: "Indian Institute of Technology (IIT) Mandi",
    period: "Oct 2024 — Oct 2025",
    gpa: "7.4 / 10",
    status: "COMPLETED",
    highlights: [
      "Specialized coursework in advanced computing paradigms, artificial intelligence architectures, and distributed systems."
    ]
  }
];

export const certifications = [
  { name: "OpenCV Bootcamp", issuer: "OpenCV.org", date: "March 2025" },
  { name: "ChatGPT Prompt Engineering for Developers", issuer: "DeepLearning.AI", date: "December 2024" }
];
